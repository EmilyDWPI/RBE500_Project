...
class Metaclass_Control(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_interfaces.srv import _control
...
class Control(metaclass=Metaclass_Control):
    from custom_interfaces.srv._control import Control_Request as Request
    from custom_interfaces.srv._control import Control_Response as Response
