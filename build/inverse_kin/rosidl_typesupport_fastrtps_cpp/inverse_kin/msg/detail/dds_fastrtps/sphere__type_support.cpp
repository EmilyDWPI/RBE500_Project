...
#include "inverse_kin/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const inverse_kin::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  inverse_kin::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = inverse_kin::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const inverse_kin::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<inverse_kin::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &inverse_kin::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, inverse_kin, msg, Sphere)() {
  return &inverse_kin::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
